...
- Package revision a SHA-256 manifestu:
- Overenie manifestu: `PASS / FAIL`
- Najvyššia dosiahnutá úroveň: `T0 / T1 / T2 / T3`
- Oficiálna vetva bez odchýlky: `PASS / FAIL / NOT_RUN`
- Deklarované odchýlky:
...
|---|---|---|---|---|
| checkpoint/order/parity | `OBSERVED_IN_PRIMARY / INDEPENDENTLY_RECOMPUTED / INFERRED_FROM_PROJECT_DOCS / CONTEXT_ONLY` |  |  |  |
| exact driver/holdout | `OBSERVED_IN_PRIMARY / INDEPENDENTLY_RECOMPUTED / INFERRED_FROM_PROJECT_DOCS / CONTEXT_ONLY` |  |  |  |
| scoped C2 dopad | `OBSERVED_IN_PRIMARY / INDEPENDENTLY_RECOMPUTED / INFERRED_FROM_PROJECT_DOCS / CONTEXT_ONLY` |  |  |  |
...
- Dopad na fyzikálny scope/verdict:
