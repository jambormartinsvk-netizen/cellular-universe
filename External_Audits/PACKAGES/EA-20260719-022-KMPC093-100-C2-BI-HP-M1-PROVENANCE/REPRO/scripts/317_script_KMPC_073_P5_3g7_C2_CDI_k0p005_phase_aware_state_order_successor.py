"""Phase-aware state-order runner for KMPC-073 C2 CDI/k=.005 resume.
...
from baseScripts.p5_general_synchronous import c2_checkpointed_single_atom_v3_phase_order as audit  # noqa: E402


if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-073 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-073",
    phase="resume",
    output_name="RUN_KMPC_073_P5_3G7_C2_CDI_K0p005_SUPPORT_07_09_PHASE_ORDER_SUCCESSOR.json",
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-073",
        audit_module="baseScripts.p5_general_synchronous.c2_checkpointed_single_atom_v3_phase_order",
        aggregate_name="NOT_AVAILABLE_KMPC_073.json",
