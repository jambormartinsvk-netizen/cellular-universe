"""Thin configured runner for KMPC-079 C2 BI/k=.15 nominal.
...
adapter.configure(
    run_id="KMPC-079", mode="BI", k_mpc=0.15,
    output_name="RUN_KMPC_079_P5_3G7_C2_BI_K0p15_NOMINAL.json",
    accepted=(0, 5), audit=(0, 7), m1_depth=7,
    prerequisite_name="RUN_KMPC_078_P5_3G7_C2_BI_K0p005_SUPPORT_07_09_CHECKPOINT_RESUME.json",
    prerequisite_sha256="F24894A043B531825DD36A424637D1E70244F89B66678AF945EA6C135918A359",
    prerequisite_candidate="PASS_C2_BI_K0p005_SUPPORT_07_ADEQUATE_CANDIDATE_ONLY",
)
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_078_P5_3G7_C2_BI_K0p005_SUPPORT_07_09_CHECKPOINT_RESUME.json": "F24894A043B531825DD36A424637D1E70244F89B66678AF945EA6C135918A359",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_079.json",
