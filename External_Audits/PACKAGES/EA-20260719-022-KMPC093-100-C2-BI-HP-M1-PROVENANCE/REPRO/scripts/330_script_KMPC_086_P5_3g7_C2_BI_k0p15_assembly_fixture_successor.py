"""Affine-fixture successor for KMPC-086 BI/k=.15 holdout assembly.
...
from baseScripts.p5_general_synchronous import c2_bi_k0p15_high_precision_holdout_assembly_v3_fixture as audit  # noqa: E402

if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-086 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-086", mode="BI", k_mpc=0.15,
    output_name="RUN_KMPC_086_P5_3G7_C2_BI_K0p15_HP_HOLDOUT_ASSEMBLY_FIXTURE_SUCCESSOR.json",
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-086",
        audit_module="baseScripts.p5_general_synchronous.c2_bi_k0p15_high_precision_holdout_assembly_v3_fixture",
        aggregate_name="NOT_AVAILABLE_KMPC_086.json",
