...
výnimka je tým lokalizovaná na HP solver/algoritmickú hranicu, nie na
projected rank alebo assembly. C2 je `5/10 PASS`; ďalší krok je samostatný
rank-revealing HP audit tej istej M1 matice bez downstream fyziky.
...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `5/10 PASS` | AD/CDI a BI/k=.005 uzavreté; BI/k=.15 M1 matrix provenance vylúčila projected rank/assembly a otvorila rank-revealing HP solver audit |
