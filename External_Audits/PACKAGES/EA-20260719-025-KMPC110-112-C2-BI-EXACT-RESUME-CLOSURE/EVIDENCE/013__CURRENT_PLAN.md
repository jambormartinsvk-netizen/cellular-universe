...
audit dokument 179 uzavrel BI/k=.15 scoped PASS. C2 je `6/10 PASS`; ďalší
atóm je `NID/k=.005/nominal`.
...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `6/10 PASS` | AD/CDI/BI sú uzavreté na oboch k; ďalší frozen atóm je NID/k=.005, potom zostávajú NID/.15 a oba NIV body |
...
1. kontrakt S1/doc51 a `.05/nominal` support sú scoped PASS; KMPC-063/066
   uzavreli AD, KMPC-073/075 CDI a KMPC-078/112 BI na oboch k, takže C2 je
   `6/10 PASS`; ďalší krok je frozen `NID/k=.005/nominal` s accepted
   `[0,5]`, audit `[0,7]`, M1 depth 7 a nezmenenými prahmi;
