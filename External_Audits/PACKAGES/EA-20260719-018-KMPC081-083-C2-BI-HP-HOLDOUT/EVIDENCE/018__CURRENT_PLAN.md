...
C2 je `5/10 PASS`; ďalší krok je exact/high-precision assembly audit bez
pridania holdoutu do fitu.
...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `5/10 PASS` | AD/CDI a BI/k=.005 uzavreté; BI/k=.15 čaká na exact-assembly holdout audit |
...
1. kontrakt S1/doc51 a `.05/nominal` support sú scoped PASS; KMPC-063/066
   ...
   KMPC-083 vylúčil solve-roundoff BI/`.15`; ďalší krok je exact/high-precision
   assembly audit bez zmeny prahov alebo pridania holdoutu do fitovanej matice;
