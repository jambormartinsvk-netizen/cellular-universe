"""CLI runner for KMPC-133 CDI/.15 C3 same-matrix refinement.
...
from baseScripts.p5_general_synchronous import (
    c3_zero_variant_parallel_v5_cdi_k0p15_same_matrix_refinement as c3,
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run CDI/.15 C3 pair through four same-matrix-refined shards."
    )
    ...
    parser.add_argument("--mode", choices=("CDI",), required=True)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if not _records_pass(records):
            raise RuntimeError("one or more KMPC-133 support workers failed")
        ...
        failure_payload = {
            ...
            "identity": {
                ...
                "physical_receipt": "CDI_K0p15_same_matrix_refinement_four_shards",
            },
    ...
    print(json.dumps({
        ...
        "same_matrix_refinement_pass": payload["same_matrix_refinement_pass"],
