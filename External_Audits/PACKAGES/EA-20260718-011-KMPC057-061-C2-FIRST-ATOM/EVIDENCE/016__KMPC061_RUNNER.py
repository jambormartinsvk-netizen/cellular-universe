"""Thin manifest runner for KMPC-061 C2 guard-semantics successor.
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-061",
        audit_module="baseScripts.p5_general_synchronous.c2_fourier_coverage_v4_guard_semantics",
        aggregate_name="RUN_KMPC_061_P5_3G7_C2_FOURIER_COVERAGE_AGGREGATE.json",
