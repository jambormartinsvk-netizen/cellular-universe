...
**Stav:** `ŽIVÁ / active technical counter 0/10 / .05 nominal support PASS / C2 5/10 PASS — BI/.15 checkpoint receipt-overený, exact M3 resume, S-M, hierarchy a zvyšná coverage otvorené`  
...
| P5.3 | regulárne general-synchronous seedy v plnom stave | **ČIASTOČNÝ PASS / C2 5/10 PASS** | AD/CDI a BI/`.005` uzavreté; BI/`.15` má receipt-overený HP-M1/F0/M3 checkpoint a čaká na exact driver/holdout resume; päť atómov NOT_RUN. |
...
hashovaný checkpoint. KMPC-080 opravil BI/`.15` main driver, ale nezávislý
  ...
  `tight_coupling[7]`. Nasleduje jediný exact-driver/non-fit-holdout resume
  z checkpointu bez opakovania CPQR. C2 je `5/10 PASS`;
  päť ďalších atómov čaká. S-C zostáva conditional a fyzická S-M para otvorená.
