"""Float-product bridge coefficient-attribution successor for KMPC-091.
...
from baseScripts.p5_general_synchronous import c2_bi_k0p15_coefficient_attribution_v4_float_product as audit  # noqa: E402

if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-091 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-091", mode="BI", k_mpc=0.15,
    output_name="RUN_KMPC_091_P5_3G7_C2_BI_K0p15_COEFFICIENT_ATTRIBUTION_FLOAT_PRODUCT_SUCCESSOR.json",
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-091",
        audit_module="baseScripts.p5_general_synchronous.c2_bi_k0p15_coefficient_attribution_v4_float_product",
        aggregate_name="NOT_AVAILABLE_KMPC_091.json",
