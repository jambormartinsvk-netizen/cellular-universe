"""Same-matrix refinement runner for KMPC-075 C2 CDI/k=.15.
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-075 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-075",
    mode="CDI",
    k_mpc=0.15,
    output_name="RUN_KMPC_075_P5_3G7_C2_CDI_K0p15_SAME_MATRIX_REFINEMENT.json",
    accepted=(0, 5),
    audit=(0, 7),
    m1_depth=7,
    prerequisite_name="RUN_KMPC_074_P5_3G7_C2_CDI_K0p15_NOMINAL.json",
    prerequisite_sha256="7771610FC77C2F3AA3FD9EA7D9BDE01F9C9D8F6751AC5BCD1075E67B9FBBB1A0",
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_074_P5_3G7_C2_CDI_K0p15_NOMINAL.json": "7771610FC77C2F3AA3FD9EA7D9BDE01F9C9D8F6751AC5BCD1075E67B9FBBB1A0",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_075.json",
