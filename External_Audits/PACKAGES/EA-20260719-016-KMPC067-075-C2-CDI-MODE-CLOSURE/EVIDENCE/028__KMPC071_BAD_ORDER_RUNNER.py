"""Checkpoint-resume runner for KMPC-071 C2 CDI/k=.005 support [0,7] to [0,9].
...
from baseScripts.p5_general_synchronous import c2_checkpointed_single_atom as audit  # noqa: E402


if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-071 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-071",
    phase="resume",
    output_name="RUN_KMPC_071_P5_3G7_C2_CDI_K0p005_SUPPORT_07_09_CHECKPOINT_RESUME.json",
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-071",
        audit_module="baseScripts.p5_general_synchronous.c2_checkpointed_single_atom",
        aggregate_name="NOT_AVAILABLE_KMPC_071.json",
