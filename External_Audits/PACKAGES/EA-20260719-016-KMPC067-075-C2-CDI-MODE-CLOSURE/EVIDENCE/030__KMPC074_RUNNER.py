"""Thin configured runner for KMPC-074 C2 CDI/k=.15 nominal.
...
adapter.configure(
    ...
    mode="CDI",
    k_mpc=0.15,
    output_name="RUN_KMPC_074_P5_3G7_C2_CDI_K0p15_NOMINAL.json",
    accepted=(0, 5),
    audit=(0, 7),
    m1_depth=7,
    prerequisite_name="RUN_KMPC_073_P5_3G7_C2_CDI_K0p005_SUPPORT_07_09_PHASE_ORDER_SUCCESSOR.json",
    prerequisite_sha256="B7B2B7231E20D90D7EA71F1934B795296B7B0C2772148988C0FCFB2CF96E8498",
    prerequisite_candidate="PASS_C2_CDI_K0p005_SUPPORT_07_ADEQUATE_CANDIDATE_ONLY",
)
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_073_P5_3G7_C2_CDI_K0p005_SUPPORT_07_09_PHASE_ORDER_SUCCESSOR.json": "B7B2B7231E20D90D7EA71F1934B795296B7B0C2772148988C0FCFB2CF96E8498",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_074.json",
