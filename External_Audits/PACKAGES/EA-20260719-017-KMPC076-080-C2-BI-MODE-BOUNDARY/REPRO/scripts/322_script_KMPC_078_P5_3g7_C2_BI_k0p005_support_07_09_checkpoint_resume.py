"""Checkpoint-resume runner for KMPC-078 C2 BI/k=.005 [0,7] to [0,9].
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-078 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-078", phase="resume", mode="BI", k_mpc=0.005,
    accepted=(0, 7), audit=(0, 9), m1_depth=9,
    output_name="RUN_KMPC_078_P5_3G7_C2_BI_K0p005_SUPPORT_07_09_CHECKPOINT_RESUME.json",
    checkpoint_name="RUN_KMPC_077_P5_3G7_C2_BI_K0p005_SUPPORT_07_ACCEPTED_CHECKPOINT.json",
    checkpoint_sha256="68A7B968A0FBDC0779D983B052C00ED05D01CAE0114D40224FAC705F09F103E8",
    prerequisite_name="RUN_KMPC_076_P5_3G7_C2_BI_K0p005_NOMINAL.json",
    prerequisite_sha256="B053B523C00032360F8FAFC47189C577B9B3D426778D881A2BD110DE3C4FCA00",
    prerequisite_candidate="REVIEW_C2_BI_K0p005_SUPPORT_07_09_REQUIRED",
)
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_076_P5_3G7_C2_BI_K0p005_NOMINAL.json": "B053B523C00032360F8FAFC47189C577B9B3D426778D881A2BD110DE3C4FCA00",
    "RUN_KMPC_077_P5_3G7_C2_BI_K0p005_SUPPORT_07_ACCEPTED_CHECKPOINT.json": "68A7B968A0FBDC0779D983B052C00ED05D01CAE0114D40224FAC705F09F103E8",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_078.json",
