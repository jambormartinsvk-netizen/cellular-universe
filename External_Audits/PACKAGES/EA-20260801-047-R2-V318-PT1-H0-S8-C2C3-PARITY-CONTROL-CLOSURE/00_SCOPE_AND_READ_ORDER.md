# EA-047-R2 — P0 ruleset-map a parity-control closure
...
**REPAIRS_MANIFEST_SHA256:** `6B29E098810E68F511910593E7EA9C08A65ABC68B750E0EAB5A2CC2B650706C5`  
**REPAIRS_FINDING_ID:** `EA047-R1-EXT-P0-001`  
**PARENT_RESPONSE_SHA256:** `FB55DA8D5FE55D85C7D7776EA27B391235A95F03658A847CFED0A94862E9E8D1`  
**ORIGINAL_T2_RESPONSE_SHA256:** `2E6316559D687F545286DD4442489BD177D94D61006B61C0EEF10B5E8CC92E6D` — hash-bound accepted upstream, nie sprístupnená sibling response  
...
ROUTE_AND_GATE: RELEASE/v3.18/PT1_H0/C2-C3 / P0_PACKAGE_CONTROL_CLOSURE
...
CHECKPOINT_STATUS: ACCEPTED_REUSABLE_CHECKPOINT_EXTERNAL_T2_CONFIRMED_P0_REPAIR_PENDING
AUDIT_SUBMISSION_ID: SUB-20260801-047-R2-001 reserved; registration/sent state lives outside immutable package
```
...
Zachováva `EVIDENCE/001-029` a oba REPRO súbory byte-identicky; audit-context
`030` je exact R1 response definujúca aktuálny ruleset-map blocker.

## Presná otázka

Obsahuje sealed charter exact `AUDITOR_RULESET_PATHS_AND_SHA256` mapu a
zachováva opravu `02/03` tak, že:
...
1. `EVIDENCE/001-004`, túto exact charter mapu, manifesty, runtime map a checkpoint provenance.
2. `EVIDENCE/030__EA047_EXTERNAL_RESPONSE.md` — presný R1 closure finding.
...
4. Manifestovo overiť byte parity `EVIDENCE/001-029` a oboch `REPRO` voči
   source hashom a R1 package. Nový Python nie je požadovaný ani autorizovaný.
