# EA-047-R2 — opravený parity contract a ruleset-map closure
...
Pred posúdením tohto contractu musí exact prejsť sealed-charter
`AUDITOR_RULESET_PATHS_AND_SHA256` mapa pre `EVIDENCE/001-004`.
