"""Checkpoint-resume runner for KMPC-120 C2 NIV/k=.005 [-1,6] to [-1,8].
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-120 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-120", phase="resume", mode="NIV", k_mpc=0.005,
    accepted=(-1, 6), audit=(-1, 8), m1_depth=8,
    output_name="RUN_KMPC_120_P5_3G7_C2_NIV_K0p005_SUPPORT_06_08_CHECKPOINT_RESUME.json",
    checkpoint_name="RUN_KMPC_119_P5_3G7_C2_NIV_K0p005_SUPPORT_06_ACCEPTED_CHECKPOINT.json",
    checkpoint_sha256="0E87C19C706D2D8AE9FA1FF2771B46FEEF308327C5B459024175566BAF4ECEE9",
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_119_P5_3G7_C2_NIV_K0p005_SUPPORT_06_ACCEPTED_CHECKPOINT.json": "0E87C19C706D2D8AE9FA1FF2771B46FEEF308327C5B459024175566BAF4ECEE9",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_120.json",
