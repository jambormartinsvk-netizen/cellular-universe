"""Multi-rank refinement runner for KMPC-126 C2 NIV/k=.15.
...
from baseScripts.p5_general_synchronous import c2_same_matrix_refinement_v2_multi_rank as audit  # noqa: E402


if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-126 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-126", mode="NIV", k_mpc=0.15,
    output_name=(
        "RUN_KMPC_126_P5_3G7_C2_NIV_K0p15_SUPPORT_06_08_"
...
EXPECTED_SOURCE_HASHES = {
    ...
    "c2_cdi_k0p15_same_matrix_refinement.py": "EA589E4CBAD3AD618DEBC41C81B271EAC23F229AEA82C80E962CD792091468F6",
    "c2_same_matrix_refinement_v2_multi_rank.py": "1E2600C366590B7FC56289D1FBC386EF24DA50DA9ED5686AE5FB5A50E0992F08",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        audit_module=(
            ...
            "c2_same_matrix_refinement_v2_multi_rank"
        ),
        aggregate_name="NOT_AVAILABLE_KMPC_126.json",
