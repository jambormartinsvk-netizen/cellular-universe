"""Same-matrix refinement runner for KMPC-122 C2 NIV/k=.15.
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-122 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-122", mode="NIV", k_mpc=0.15,
    output_name="RUN_KMPC_122_P5_3G7_C2_NIV_K0p15_SAME_MATRIX_REFINEMENT.json",
    accepted=(-1, 4), audit=(-1, 6), m1_depth=6,
    prerequisite_name="RUN_KMPC_121_P5_3G7_C2_NIV_K0p15_NOMINAL.json",
    prerequisite_sha256="8E5E8107833C9F2858BA180F9DBC3DFA4037566CCC2F7D30AF819B1FC94C0BEE",
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_121_P5_3G7_C2_NIV_K0p15_NOMINAL.json": "8E5E8107833C9F2858BA180F9DBC3DFA4037566CCC2F7D30AF819B1FC94C0BEE",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_122.json",
