...
**Stav:** `ŽIVÁ / active technical counter 0/10 / .05 nominal support PASS / C2 atómy 10/10 PASS, aggregate NOT_RUN — všetky mode×k atómy uzavreté; S-M, hierarchy a zvyšná coverage otvorené`  
...
| P5.3 | regulárne general-synchronous seedy v plnom stave | **ČIASTOČNÝ PASS / C2 ATÓMY 10/10 PASS / AGGREGATE NOT_RUN** | všetkých päť módov na oboch k je scoped PASS; pred C3 je povinný read-only aggregate. |
...
hashovaný checkpoint. KMPC-080 opravil BI/`.15` main driver, ale nezávislý
  ...
  Interný audit 197 uzavrel NIV mód. C2 atómy sú `10/10 PASS`; aggregate
  ešte nebežal. S-C zostáva conditional a fyzická S-M para otvorená.
