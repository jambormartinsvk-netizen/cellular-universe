"""Thin configured runner for KMPC-121 C2 NIV/k=.15 nominal.
...
adapter.configure(
    ...
    mode="NIV",
    k_mpc=0.15,
    output_name="RUN_KMPC_121_P5_3G7_C2_NIV_K0p15_NOMINAL.json",
    accepted=(-1, 4),
    audit=(-1, 6),
    m1_depth=6,
    prerequisite_name=(
        "RUN_KMPC_120_P5_3G7_C2_NIV_K0p005_SUPPORT_06_08_"
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_121.json",
