...
**historical_packages_total:** `22` (`KMPC-081…102`)  
**consecutive_technical_failures:** `0/10` po vecnom diagnostickom výsledku KMPC-102  
**Fyzikálny stav:** `REVIEW_C2_BI_K0p15_NATIVE_HP_M1_SOLVER_BOUNDARY_CLOSED`; C2 `5/10`, K4 `60/100`
