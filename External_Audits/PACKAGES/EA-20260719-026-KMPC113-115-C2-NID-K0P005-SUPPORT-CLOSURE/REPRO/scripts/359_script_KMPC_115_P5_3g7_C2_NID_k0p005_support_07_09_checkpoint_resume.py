"""Checkpoint-resume runner for KMPC-115 C2 NID/k=.005 [0,7] to [0,9].
...
from baseScripts.p5_general_synchronous import c2_configurable_checkpoint as audit  # noqa: E402


if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-115 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-115", phase="resume", mode="NID", k_mpc=0.005,
    accepted=(0, 7), audit=(0, 9), m1_depth=9,
    output_name="RUN_KMPC_115_P5_3G7_C2_NID_K0p005_SUPPORT_07_09_CHECKPOINT_RESUME.json",
    checkpoint_name="RUN_KMPC_114_P5_3G7_C2_NID_K0p005_SUPPORT_07_ACCEPTED_CHECKPOINT.json",
    checkpoint_sha256="339FD13BE750060793FCE04698BA5726AFD58DCB08BBDD3DB7B1FDFE76B35195",
    prerequisite_name="RUN_KMPC_113_P5_3G7_C2_NID_K0p005_NOMINAL.json",
    prerequisite_sha256="DD5B3075AB7581C4DC590CFE668952217B58C969B07FEC1CCDE5FA02C7B3B533",
    prerequisite_candidate="REVIEW_C2_NID_K0p005_SUPPORT_07_09_REQUIRED",
)
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_113_P5_3G7_C2_NID_K0p005_NOMINAL.json": "DD5B3075AB7581C4DC590CFE668952217B58C969B07FEC1CCDE5FA02C7B3B533",
    "RUN_KMPC_114_P5_3G7_C2_NID_K0p005_SUPPORT_07_ACCEPTED_CHECKPOINT.json": "339FD13BE750060793FCE04698BA5726AFD58DCB08BBDD3DB7B1FDFE76B35195",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-115",
        audit_module="baseScripts.p5_general_synchronous.c2_configurable_checkpoint",
        aggregate_name="NOT_AVAILABLE_KMPC_115.json",
