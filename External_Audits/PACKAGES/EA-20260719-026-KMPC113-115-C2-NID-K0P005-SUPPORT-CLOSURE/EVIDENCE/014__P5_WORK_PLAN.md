...
**Stav:** `ŽIVÁ / active technical counter 0/10 / .05 nominal support PASS / C2 7/10 PASS — AD/CDI/BI oba k a NID/.005 uzavreté; NID/.15, NIV, S-M, hierarchy a zvyšná coverage otvorené`  
...
| P5.3 | regulárne general-synchronous seedy v plnom stave | **ČIASTOČNÝ PASS / C2 7/10 PASS** | AD/CDI/BI oba k a NID/`.005` uzavreté; ďalší je NID/`.15`, potom oba NIV body; tri atómy NOT_RUN. |
...
hashovaný checkpoint. KMPC-080 opravil BI/`.15` main driver, ale nezávislý
  ...
  183 udelil scoped PASS. C2 je `7/10 PASS`; tri ďalšie atómy čakajú.
  Ďalší je NID/`.15` s frozen `[0,5]→[0,7]`. S-C zostáva conditional a
  fyzická S-M para otvorená.
