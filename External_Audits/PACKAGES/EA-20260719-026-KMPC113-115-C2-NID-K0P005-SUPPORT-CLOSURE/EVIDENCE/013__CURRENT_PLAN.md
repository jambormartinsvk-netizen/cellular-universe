...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `7/10 PASS` | AD/CDI/BI a NID/k=.005 sú uzavreté; ďalší frozen atóm je NID/k=.15, potom oba NIV body |
...
1. kontrakt S1/doc51 a `.05/nominal` support sú scoped PASS; KMPC-063/066
   uzavreli AD, KMPC-073/075 CDI, KMPC-078/112 BI a KMPC-115 NID/k=.005,
   takže C2 je `7/10 PASS`; po externom balíku EA-026 je ďalší krok frozen
   `NID/k=.15/nominal` s accepted `[0,5]`, audit `[0,7]`, M1 depth 7 a
   nezmenenými prahmi;
