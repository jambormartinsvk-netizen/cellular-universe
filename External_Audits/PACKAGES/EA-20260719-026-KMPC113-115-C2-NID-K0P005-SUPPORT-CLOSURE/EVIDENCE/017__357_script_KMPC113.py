"""Thin configured runner for KMPC-113 C2 NID/k=.005 nominal.
...
adapter.configure(
    ...
    mode="NID",
    k_mpc=0.005,
    output_name="RUN_KMPC_113_P5_3G7_C2_NID_K0p005_NOMINAL.json",
    accepted=(0, 5),
    audit=(0, 7),
    m1_depth=7,
    prerequisite_name=(
        "RUN_KMPC_112_P5_3G7_C2_BI_K0p15_HP_M1_CHECKPOINT_"
        "EXACT_RESUME_JSON_PARITY_SUCCESSOR.json"
    ),
    prerequisite_sha256=(
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_113.json",
