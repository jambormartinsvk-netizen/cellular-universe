"""Checkpoint runner for KMPC-070 C2 CDI/k=.005 accepted support [0,7].
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-070 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-070",
    phase="checkpoint",
    output_name="RUN_KMPC_070_P5_3G7_C2_CDI_K0p005_SUPPORT_07_ACCEPTED_CHECKPOINT.json",
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_070.json",
