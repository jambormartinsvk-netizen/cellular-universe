"""Hash-owner successor for KMPC-085 BI/k=.15 holdout assembly.
...
from baseScripts.p5_general_synchronous import c2_bi_k0p15_high_precision_holdout_assembly_v2_hash_owner as audit  # noqa: E402

if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-085 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-085", mode="BI", k_mpc=0.15,
    output_name="RUN_KMPC_085_P5_3G7_C2_BI_K0p15_HP_HOLDOUT_ASSEMBLY_HASH_OWNER_SUCCESSOR.json",
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-085",
        audit_module="baseScripts.p5_general_synchronous.c2_bi_k0p15_high_precision_holdout_assembly_v2_hash_owner",
        aggregate_name="NOT_AVAILABLE_KMPC_085.json",
