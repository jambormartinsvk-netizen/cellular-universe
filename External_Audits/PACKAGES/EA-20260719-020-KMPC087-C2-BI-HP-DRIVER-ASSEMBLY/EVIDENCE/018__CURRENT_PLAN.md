...
vylúčené. C2 je `5/10 PASS`; ďalší krok je upstream coefficient-attribution
ledger pre M1/F0/background bez pridania holdoutu do fitu.
...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `5/10 PASS` | AD/CDI a BI/k=.005 uzavreté; BI/k=.15 čaká na upstream coefficient-attribution po exact driver REVIEW |
