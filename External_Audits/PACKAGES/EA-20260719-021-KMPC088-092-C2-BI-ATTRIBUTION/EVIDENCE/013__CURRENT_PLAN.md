...
`-1.80023e-11`. C2 je `5/10 PASS`; ďalší krok izoluje high-precision M1 od
background generátora bez pridania holdoutu do fitu.
...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `5/10 PASS` | AD/CDI a BI/k=.005 uzavreté; BI/k=.15 attribution ukázala dominantný fractional-background × M1 blok, ktorý čaká na izoláciu |
