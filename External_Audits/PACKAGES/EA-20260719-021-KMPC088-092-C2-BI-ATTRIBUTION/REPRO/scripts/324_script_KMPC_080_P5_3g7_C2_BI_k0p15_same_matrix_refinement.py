"""Same-matrix refinement runner for KMPC-080 C2 BI/k=.15.
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-080 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-080", mode="BI", k_mpc=0.15,
    output_name="RUN_KMPC_080_P5_3G7_C2_BI_K0p15_SAME_MATRIX_REFINEMENT.json",
    accepted=(0, 5), audit=(0, 7), m1_depth=7,
    prerequisite_name="RUN_KMPC_079_P5_3G7_C2_BI_K0p15_NOMINAL.json",
    prerequisite_sha256="014B3F7E76929ED7C3DC894C8B84550AB68435BF7BC2A650788801D786D4A5E5",
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_079_P5_3G7_C2_BI_K0p15_NOMINAL.json": "014B3F7E76929ED7C3DC894C8B84550AB68435BF7BC2A650788801D786D4A5E5",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_080.json",
