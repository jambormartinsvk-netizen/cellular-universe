...
| P5.3 | B1 PASS; C2 atómy `10/10 PASS`; aggregate PASS; C3 odblokovaná | KMPC-127 overil kartézsky register a background spread; C3 potrebuje vlastný frozen kontrakt pred Python procesom |
...
1. C2 mode×k register aj povinný read-only aggregate majú PASS; po
   zapečatení balíka EA-029 je ďalší krok samostatne odvodiť a predregistrovať
   C3 `gamma0/af0` kontrakt bez domýšľania rovníc alebo prahov;
