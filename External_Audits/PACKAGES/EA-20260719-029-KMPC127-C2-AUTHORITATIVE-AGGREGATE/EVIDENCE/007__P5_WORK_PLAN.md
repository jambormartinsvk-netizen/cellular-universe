...
**Stav:** `ŽIVÁ / active technical counter 0/10 / C2 10/10 + aggregate PASS / C3 odblokovaná — S-M, hierarchy a zvyšná coverage otvorené`  
...
| P5.3 | regulárne general-synchronous seedy v plnom stave | **ČIASTOČNÝ PASS / C2 10/10 + AGGREGATE PASS / C3 UNLOCKED** | KMPC-127 overil exact register a background spread; ďalší je samostatný C3 kontrakt, nie P5.4. |
...
hashovaný checkpoint. KMPC-080 opravil BI/`.15` main driver, ale nezávislý
  ...
  aggregate a odblokoval C3. S-C zostáva conditional a fyzická S-M para otvorená.
