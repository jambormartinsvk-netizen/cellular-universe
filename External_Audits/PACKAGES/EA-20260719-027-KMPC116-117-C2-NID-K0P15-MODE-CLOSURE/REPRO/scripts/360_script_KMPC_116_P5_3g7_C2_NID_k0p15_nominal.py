"""Thin configured runner for KMPC-116 C2 NID/k=.15 nominal.
...
adapter.configure(
    ...
    mode="NID",
    k_mpc=0.15,
    output_name="RUN_KMPC_116_P5_3G7_C2_NID_K0p15_NOMINAL.json",
    accepted=(0, 5),
    audit=(0, 7),
    m1_depth=7,
    prerequisite_name=(
        "RUN_KMPC_115_P5_3G7_C2_NID_K0p005_SUPPORT_07_09_"
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_116.json",
