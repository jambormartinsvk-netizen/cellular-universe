...
`8/10 PASS`; zostávajú oba NIV atómy.
...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `8/10 PASS` | AD/CDI/BI/NID sú uzavreté na oboch k; zostávajú NIV/k=.005 a NIV/k=.15 |
...
1. kontrakt S1/doc51 a `.05/nominal` support sú scoped PASS; KMPC-063/066
   uzavreli AD, KMPC-073/075 CDI, KMPC-078/112 BI a KMPC-115/117 NID na
   oboch k, takže C2 je `8/10 PASS`; po externom balíku EA-027 je ďalší
   krok frozen `NIV/k=.005/nominal` s accepted `[-1,4]`, audit `[-1,6]`,
   M1 depth 6 a nezmenenými prahmi;
