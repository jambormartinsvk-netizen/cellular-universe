"""Same-matrix refinement runner for KMPC-117 C2 NID/k=.15.
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-117 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-117", mode="NID", k_mpc=0.15,
    output_name="RUN_KMPC_117_P5_3G7_C2_NID_K0p15_SAME_MATRIX_REFINEMENT.json",
    accepted=(0, 5), audit=(0, 7), m1_depth=7,
    prerequisite_name="RUN_KMPC_116_P5_3G7_C2_NID_K0p15_NOMINAL.json",
    prerequisite_sha256="0965E3D1F7726CC851B3D1B6043468169ADEBED44096B010565F768DBD8E25AB",
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_116_P5_3G7_C2_NID_K0p15_NOMINAL.json": "0965E3D1F7726CC851B3D1B6043468169ADEBED44096B010565F768DBD8E25AB",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_117.json",
