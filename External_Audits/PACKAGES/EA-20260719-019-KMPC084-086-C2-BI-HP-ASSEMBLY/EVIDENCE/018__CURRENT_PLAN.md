...
rovnakých `3.019756712e-9`; posledné holdout zostavenie ani odčítanie teda
nie je príčina. C2 je `5/10 PASS`; ďalší krok je 80-dps assembly tej istej
104×104 driver matice bez pridania holdoutu do fitu.
...
| P5.3 | B1 PASS; `.05/nominal` support uzavretý; C2 `5/10 PASS` | AD/CDI a BI/k=.005 uzavreté; BI/k=.15 čaká na exact driver-assembly audit |
...
1. kontrakt S1/doc51 a `.05/nominal` support sú scoped PASS; KMPC-063/066
   ...
   KMPC-083 vylúčil solve-roundoff BI/`.15` a KMPC-086 vylúčil posledné
   holdout-assembly odčítanie; ďalší krok je 80-dps assembly tej istej driver
   matice bez zmeny prahov alebo pridania holdoutu do fitovanej matice;
