"""High-precision independent-holdout assembly audit for KMPC-084.
...
from baseScripts.p5_general_synchronous import c2_bi_k0p15_high_precision_holdout_assembly as audit  # noqa: E402

if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-084 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-084", mode="BI", k_mpc=0.15,
    output_name="RUN_KMPC_084_P5_3G7_C2_BI_K0p15_HIGH_PRECISION_HOLDOUT_ASSEMBLY.json",
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-084",
        audit_module="baseScripts.p5_general_synchronous.c2_bi_k0p15_high_precision_holdout_assembly",
        aggregate_name="NOT_AVAILABLE_KMPC_084.json",
