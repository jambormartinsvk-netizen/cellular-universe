"""CLI runner for KMPC-135 BI/.15 phase-separated HP-M1 exact resume.
...
from baseScripts.p5_general_synchronous import (
    c3_zero_variant_parallel_v7_bi_k0p15_phase_separated_exact_resume as c3,
)


RUN_ID = "KMPC-135"
EXPECTED_BASE_SHA256 = (
    "64662CC4C1EFFB607E786D060B03DD26CD10FA90DDF7DD6E5226BAA7588C5841"
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Run BI/.15 C3 pair through four phase-separated HP-M1 "
            "exact-resume shards."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if not _records_pass(records):
            raise RuntimeError("one or more KMPC-135 support workers failed")
        ...
        failure_payload = {
            ...
            "identity": {
                ...
                "physical_receipt": (
                    "BI_K0p15_phase_separated_HP_M1_exact_resume_four_shards"
                ),
            },
