"""Thin configured runner for KMPC-118 C2 NIV/k=.005 nominal.
...
adapter.configure(
    ...
    mode="NIV",
    k_mpc=0.005,
    output_name="RUN_KMPC_118_P5_3G7_C2_NIV_K0p005_NOMINAL.json",
    accepted=(-1, 4),
    audit=(-1, 6),
    m1_depth=6,
    prerequisite_name=(
        "RUN_KMPC_117_P5_3G7_C2_NID_K0p15_SAME_MATRIX_REFINEMENT.json"
    ),
    prerequisite_sha256=(
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_118.json",
