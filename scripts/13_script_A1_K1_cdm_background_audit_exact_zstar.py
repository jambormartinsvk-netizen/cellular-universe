#!/usr/bin/env python3
"""Working successor to scripts 11 and 12 for the A1-K1 background audit.

Changes relative to script 12:
- register the dynamically loaded base module in sys.modules before execution,
  which is required by Python 3.11 dataclasses.

The physics equations, exact-z_star grid, diagnostics, and thresholds are
otherwise unchanged.
"""
