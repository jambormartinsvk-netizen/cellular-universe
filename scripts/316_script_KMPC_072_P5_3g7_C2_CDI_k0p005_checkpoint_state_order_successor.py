"""State-order successor runner for KMPC-072 C2 CDI/k=.005 checkpoint resume.
...
from baseScripts.p5_general_synchronous import c2_checkpointed_single_atom_v2_state_order as audit  # noqa: E402


if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-072 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-072",
    phase="resume",
    output_name="RUN_KMPC_072_P5_3G7_C2_CDI_K0p005_SUPPORT_07_09_STATE_ORDER_SUCCESSOR.json",
    checkpoint_name="RUN_KMPC_070_P5_3G7_C2_CDI_K0p005_SUPPORT_07_ACCEPTED_CHECKPOINT.json",
    checkpoint_sha256="AD8CD12F5E6CBABE28C512DFDA6D3867C3E713F5582E152F6289CD78540A7D00",
    prerequisite_name="RUN_KMPC_067_P5_3G7_C2_CDI_K0p005_NOMINAL.json",
    prerequisite_sha256="DC11201E7301831153F4D3D5450A95FC1D5F311E5EE3E9176BDE6E471F657F8F",
    prerequisite_candidate="REVIEW_C2_CDI_K0p005_SUPPORT_07_09_REQUIRED",
)
...
EXPECTED_SOURCE_HASHES = {
    ...
    "c2_checkpointed_single_atom_v2_state_order.py": "7B41EC182ED87597A7719CC3AF9632CEC92BA9E7AC411C6EE5A724EC1A02F3D7",
}
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_067_P5_3G7_C2_CDI_K0p005_NOMINAL.json": "DC11201E7301831153F4D3D5450A95FC1D5F311E5EE3E9176BDE6E471F657F8F",
    "RUN_KMPC_070_P5_3G7_C2_CDI_K0p005_SUPPORT_07_ACCEPTED_CHECKPOINT.json": "AD8CD12F5E6CBABE28C512DFDA6D3867C3E713F5582E152F6289CD78540A7D00",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-072",
        audit_module="baseScripts.p5_general_synchronous.c2_checkpointed_single_atom_v2_state_order",
        aggregate_name="NOT_AVAILABLE_KMPC_072.json",
