"""Thin manifest runner for KMPC-062 AD/k=.005 support ladder.
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_061_P5_3G7_C2_AD_K0p005_NOMINAL.json": "0952AF08B1DE291D015F71396954F70EAE2F78A962E1EE1D3A08ECA48A1F5DCD",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-062",
        audit_module="baseScripts.p5_general_synchronous.c2_ad_k0p005_support_04_06",
        aggregate_name="NOT_AVAILABLE_KMPC_062.json",
