"""Thin configured runner for KMPC-068 C2 CDI/k=.005 support [0,7] to [0,9].
...
adapter.configure(
    ...
    mode="CDI",
    k_mpc=0.005,
    output_name="RUN_KMPC_068_P5_3G7_C2_CDI_K0p005_SUPPORT_07_09.json",
    accepted=(0, 7),
    audit=(0, 9),
    m1_depth=9,
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_068.json",
