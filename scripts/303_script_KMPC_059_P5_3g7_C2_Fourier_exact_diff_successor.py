"""Thin manifest runner for KMPC-059 C2 Fourier exact-diff successor.
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-059",
        audit_module="baseScripts.p5_general_synchronous.c2_fourier_coverage_v3_exact_diff",
        aggregate_name="RUN_KMPC_059_P5_3G7_C2_FOURIER_COVERAGE_AGGREGATE.json",
