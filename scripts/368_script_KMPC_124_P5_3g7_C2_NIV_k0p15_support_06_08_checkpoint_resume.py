"""Checkpoint-resume runner for KMPC-124 C2 NIV/k=.15 [-1,6] to [-1,8].
...
if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-124 deterministic single-thread environment not active")

audit.configure(
    run_id="KMPC-124", phase="resume", mode="NIV", k_mpc=0.15,
    accepted=(-1, 6), audit=(-1, 8), m1_depth=8,
    output_name="RUN_KMPC_124_P5_3G7_C2_NIV_K0p15_SUPPORT_06_08_CHECKPOINT_RESUME.json",
    checkpoint_name="RUN_KMPC_123_P5_3G7_C2_NIV_K0p15_SUPPORT_06_ACCEPTED_CHECKPOINT.json",
    checkpoint_sha256="D3B31093D84156D05BF4EE8EC707D53B5D653DE5700289E6EA68627674898DC8",
    prerequisite_name="RUN_KMPC_122_P5_3G7_C2_NIV_K0p15_SAME_MATRIX_REFINEMENT.json",
    prerequisite_sha256="BAC68E1D85802852EEBF4B1AC2E277EC15FD32264E166F673D486FD747869419",
    prerequisite_candidate="REVIEW_C2_NIV_K0p15_SUPPORT_06_08_REQUIRED",
)
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_122_P5_3G7_C2_NIV_K0p15_SAME_MATRIX_REFINEMENT.json": "BAC68E1D85802852EEBF4B1AC2E277EC15FD32264E166F673D486FD747869419",
    "RUN_KMPC_123_P5_3G7_C2_NIV_K0p15_SUPPORT_06_ACCEPTED_CHECKPOINT.json": "D3B31093D84156D05BF4EE8EC707D53B5D653DE5700289E6EA68627674898DC8",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_124.json",
