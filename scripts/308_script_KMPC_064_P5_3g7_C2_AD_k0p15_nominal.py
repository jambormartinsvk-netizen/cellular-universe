"""Thin manifest runner for KMPC-064 C2 AD/k=.15 nominal.
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-064",
        audit_module="baseScripts.p5_general_synchronous.c2_ad_k0p15_nominal",
        aggregate_name="NOT_AVAILABLE_KMPC_064.json",
