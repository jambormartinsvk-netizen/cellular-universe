"""Single-thread successor for KMPC-069 C2 CDI/k=.005 support [0,7] to [0,9].
...
from baseScripts.p5_general_synchronous import c2_single_atom_adapter as adapter  # noqa: E402


if any(os.environ.get(name) != value for name, value in THREAD_ENV.items()):
    raise RuntimeError("KMPC-069 deterministic single-thread environment not active")

adapter.configure(
    run_id="KMPC-069",
    mode="CDI",
    k_mpc=0.005,
    output_name="RUN_KMPC_069_P5_3G7_C2_CDI_K0p005_SUPPORT_07_09_SINGLE_THREAD.json",
    accepted=(0, 7),
    audit=(0, 9),
    m1_depth=9,
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_069.json",
