"""Thin manifest runner for KMPC-066 AD/k=.15 support ladder.
...
EXPECTED_SOURCE_HASHES = {
    ...
    "c2_ad_k0p15_support_04_06.py": "7A52C7940EBCD70EC727EC4AB014620A64EC7BAE3C22FB556ED6C2C98C10D688",
}
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_065_P5_3G7_C2_AD_K0p15_NOMINAL.json": "987E467EA2F36EA8F061F665A33AE1F6DC9AB6E2EFE9FB710E23CE0C50171636",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-066",
        audit_module="baseScripts.p5_general_synchronous.c2_ad_k0p15_support_04_06",
        aggregate_name="NOT_AVAILABLE_KMPC_066.json",
