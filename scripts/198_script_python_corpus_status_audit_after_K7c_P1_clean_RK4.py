...
EXPECTED_CORPUS_EXCLUDING_SELF = 202
...
def main() -> int:
    ...
    checks = {
        "corpus_count_excluding_auditor_is_202": len(paths) == EXPECTED_CORPUS_EXCLUDING_SELF,
    ...
    output = {
        "test": "bounded corpus status audit after K7c P1 clean RK4 creation",
