...
EXPECTED_CORPUS_EXCLUDING_SELF = 212
...
QUARANTINE["200_script_python_corpus_status_audit_after_K7c_P2_script199.py"] = item(
    "SUPERSEDED", "immutable corpus snapshot before P3a script 201", "202_script_python_corpus_status_audit_after_K7c_P3a_script201.py"
)
QUARANTINE["202_script_python_corpus_status_audit_after_K7c_P3a_script201.py"] = item(
    "SUPERSEDED", "immutable corpus snapshot before P3a-B preparation", "208_script_python_corpus_status_audit_before_K7c_P3b_script205.py"
)
QUARANTINE["203_script_A2_K4_C7_7c_K7c_P3b_zero_identity_RK4.py"] = item(
    "DO_NOT_RUN_TECHNICAL", "interrupted P3a-B scaffold; audit/export incomplete", "205_script_A2_K4_C7_7c_K7c_P3b_zero_identity_RK4_audited.py"
)
QUARANTINE["204_script_A2_K4_C7_7c_K7c_P3b_zero_identity_RK4_complete.py"] = item(
    "DO_NOT_RUN_TECHNICAL", "PF-030 output argument registered after parse_args", "205_script_A2_K4_C7_7c_K7c_P3b_zero_identity_RK4_audited.py"
)
QUARANTINE["206_script_A2_K4_C7_7c_K7c_P3b_source_delta_audit.py"] = item(
    "DO_NOT_RUN_TECHNICAL", "PF-031 tuple assignment unsupported", "207_script_A2_K4_C7_7c_K7c_P3b_source_delta_audit_tuple_fixed.py"
)
...
def main() -> int:
    ...
    checks = {
        "corpus_count_excluding_auditor_is_212": len(paths) == EXPECTED_CORPUS_EXCLUDING_SELF,
    ...
    output = {
        "test": "bounded corpus status audit before K7c P3a-B script 205 evolution",
