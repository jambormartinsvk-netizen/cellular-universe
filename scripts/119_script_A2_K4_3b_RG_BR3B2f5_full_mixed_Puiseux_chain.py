...
Corrected immutable clone of script 118.  Script 118 is retained because its
fuel-ledger initial-value list had one unmatched bracket and therefore failed
the syntax gate before doing physics.
