"""Thin manifest runner for KMPC-063 AD/k=.005 support ladder.
...
EXPECTED_SOURCE_HASHES = {
    ...
    "c2_ad_k0p005_support_04_06.py": "EFE65B1BEE946EE531A6757F95CAFB103EE8D1320FB363009F624A69156EEFC8",
    "c2_ad_k0p005_support_06_08.py": "BA940220B1CDFCF155FF5ABE274B48391477EB6C6F255A7DCAC706F9DF55193E",
}
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_062_P5_3G7_C2_AD_K0p005_SUPPORT_04_06.json": "640057CB6AC3F059988D6BD6C0CBE65ABAC1712F18961A2FEAFA5E1341EA6760",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        run_id="KMPC-063",
        audit_module="baseScripts.p5_general_synchronous.c2_ad_k0p005_support_06_08",
        aggregate_name="NOT_AVAILABLE_KMPC_063.json",
