"""Thin configured runner for KMPC-076 C2 BI/k=.005 nominal.
...
adapter.configure(
    ...
    mode="BI",
    k_mpc=0.005,
    output_name="RUN_KMPC_076_P5_3G7_C2_BI_K0p005_NOMINAL.json",
    accepted=(0, 5),
    audit=(0, 7),
    m1_depth=7,
    prerequisite_name="RUN_KMPC_075_P5_3G7_C2_CDI_K0p15_SAME_MATRIX_REFINEMENT.json",
    prerequisite_sha256="19F5F0B38CFE62C6E2ECA277EE5F959D866967027C5AF721CF4B2E1A30B999B9",
    prerequisite_candidate="PASS_C2_CDI_K0p15_SUPPORT_05_ADEQUATE_CANDIDATE_ONLY",
)
...
EXPECTED_PREREQUISITES = {
    ...
    "RUN_KMPC_075_P5_3G7_C2_CDI_K0p15_SAME_MATRIX_REFINEMENT.json": "19F5F0B38CFE62C6E2ECA277EE5F959D866967027C5AF721CF4B2E1A30B999B9",
}
...
if __name__ == "__main__":
    raise SystemExit(harness.run_cli(
        ...
        aggregate_name="NOT_AVAILABLE_KMPC_076.json",
