...
EXPECTED_CORPUS_EXCLUDING_SELF = 206
...
def main() -> int:
    ...
    checks = {
        "corpus_count_excluding_auditor_is_206": len(paths) == EXPECTED_CORPUS_EXCLUDING_SELF,
    ...
    output = {
        "test": "bounded corpus status audit after K7c P3a script 201 creation",
