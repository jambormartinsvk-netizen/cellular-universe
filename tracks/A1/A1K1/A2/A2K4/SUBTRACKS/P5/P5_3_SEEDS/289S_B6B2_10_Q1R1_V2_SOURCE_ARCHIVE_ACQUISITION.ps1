...
'@)
    ...
    Assert-Pass 'ALL_SUPPORTED_LITERAL_LOADERS_AND_LOCAL_STYLE_RECURSION' {
        ...
        if ($analysis.ClosureStatus -ne 'REQUIRES_MANUAL_ALL_TEXT_REVIEW') { Throw-Guard 'SELFTEST_LOADER_CLOSURE_NOT_CLEAN' }
...
function Invoke-Acquire {
    ...
    $expectedScript = Join-Path $expectedDirectory '289S_B6B2_10_Q1R1_V2_SOURCE_ARCHIVE_ACQUISITION.ps1'
