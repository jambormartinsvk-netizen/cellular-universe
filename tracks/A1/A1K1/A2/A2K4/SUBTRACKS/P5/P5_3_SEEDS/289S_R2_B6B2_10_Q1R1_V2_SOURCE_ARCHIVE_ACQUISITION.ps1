...
function Invoke-Acquire {
    ...
    $expectedScript = Join-Path $expectedDirectory '289S_R2_B6B2_10_Q1R1_V2_SOURCE_ARCHIVE_ACQUISITION.ps1'
    ...
    foreach ($marker in @(
        ...
        "FROZEN_289S_R2_SHA256: $scriptSha",
